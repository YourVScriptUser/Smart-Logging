...
game_log = SmartLogging.output(stdout="game_log.txt", auto_open=True)
game_log.set_handles("console_out", "file_out")
game_log.set_setting("{^time^} ## ^level^ ## (^component^) >> '^message^'")
game_log.print_info("Game started", component="GameEngine")
game_log.print_warn("Memory low", component="MemoryManager")
game_log.print_error("Crash imminent!", component="System")
